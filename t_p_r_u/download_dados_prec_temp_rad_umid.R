...
readr::write_csv(df_coords, 't_p_r_u/estados_coords.csv')

# Carregar o banco de dados de coordenadas

df <- read.csv('t_p_r_u/estados_coords.csv') |> select(lon,lat)
...
files_names <- list.files('t_p_r_u/data-raw/',full.names = T)
