...
#### DETER (ALB e Cerrado) *Não encontrei dados de focos de fogo para Cerrado

*Não existem dados deter para PANTANAL. Seriam necessários, visto que abrange boa parte do Brasil Central. Como proceder????

Dados adquiridos em <https://terrabrasilis.dpi.inpe.br/downloads/> (página contém o metadados)

Satélite: Landsat ou similares
...
Dados de focos de queimadas x Supressão da vegetação nativa do período de 08/2018 a 01/2025 para o Brasil adquiridos na plataforma TerraBrasilis, do INPE: <https://terrabrasilis.dpi.inpe.br/app/dashboard/fires/biomes/aggregated/#> Dados salvos em .csv na pasta "data-raw/focos_deter" como "br-18-24"
...
"data-raw/focos_deter" como "centro-oeste"
...
Código na pasta "t_p_r_u", no script "download_dados_prec_temp_rad_umid" e funções no "my_function"
...
Arquivos auxiliares: <https://appeears.earthdatacloud.nasa.gov/download/84a2e785-7668-47a1-8ac6-e9abea6c7547>